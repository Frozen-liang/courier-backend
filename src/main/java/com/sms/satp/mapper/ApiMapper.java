...
public interface ApiMapper {
    ...
    @Mapping(target = "apiProtocol",
        expression = "java(apiEntity.getApiProtocol().getCode())")
    @Mapping(target = "requestMethod",
        expression = "java(apiEntity.getRequestMethod().getCode())")
    @Mapping(target = "apiRequestParamType",
        expression = "java(apiEntity.getApiRequestParamType().getCode())")
    @Mapping(target = "apiStatus",
        expression = "java(apiEntity.getApiStatus().getCode())")

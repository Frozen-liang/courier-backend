...
public class CaseTemplateApiServiceImpl implements CaseTemplateApiService {
    ...
    @LogRecord(operationType = ADD, operationModule = CASE_TEMPLATE_API, template = "{{#addCaseTemplateApiRequest"
        + ".addCaseTemplateApiRequestList?.[#this.apiName]}}", projectId = "addCaseTemplateApiRequest"
        + ".addCaseTemplateApiRequestList[0].projectId")
    ...
    @Override
    @LogRecord(operationType = EDIT, operationModule = CASE_TEMPLATE_API, template = "{{#updateCaseTemplateApiRequest"
    ...
    @Override
    @LogRecord(operationType = EDIT, operationModule = CASE_TEMPLATE_API, template = "{{#caseTemplateApiList"
        + "?.[#this.apiName]}}", projectId = "caseTemplateApiList[0].projectId")
    ...
    @LogRecord(operationType = EDIT, operationModule = CASE_TEMPLATE_API, template = "{{#updateCaseTemplateApiDto"
        + ".updateCaseTemplateApiRequestList?.[#this.apiName]}}", projectId = "updateCaseTemplateApiDto"
        + ".updateCaseTemplateApiRequestList[0].projectId")

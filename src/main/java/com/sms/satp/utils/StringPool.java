...
/**
 * Copy to jodd.util
 * Pool of <code>String</code> constants to prevent repeating of hard-coded <code>String</code> literals in the
 * code.
 ...
 * <code>String</code> object.</li>
 * <li>Strings computed by constant expressions are computed at compile time
 * and then treated as if they were literals.</li>

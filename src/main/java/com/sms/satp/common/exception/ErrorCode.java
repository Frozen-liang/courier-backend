...
public enum ErrorCode {
    ...
    ADD_USER_GROUP_ERROR("4160", "Failed to add the UserGroup!"),
    GET_USER_GROUP_LIST_ERROR("4161", "Failed to get the UserGroup list!"),
    DELETE_USER_GROUP_BY_ID_ERROR("4162", "Failed to delete the UserGroup!"),
    EDIT_USER_GROUP_ERROR("4163", "Failed to edit the UserGroup!"),
    IMPORT_DATA_COLLECTION_ERROR("4164", "Failed to import the DataCollection!"),

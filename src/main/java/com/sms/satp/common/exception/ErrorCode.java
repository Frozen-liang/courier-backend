...
public enum ErrorCode {
    ...
    UPLOAD_TEST_FILE_ERROR("4133", "Failed to upload the TestFile!"),
    DELETE_TEST_FILE_BY_ID_ERROR("4134", "Failed to delete the TestFile!"),
    EDIT_TEST_FILE_ERROR("4135", "Failed to edit the TestFile!"),
    GET_TEST_FILE_LIST_ERROR("4136", "Failed to get the TestFile list!"),
    DOWNLOAD_TEST_FILE_ERROR("4137", "Failed to download the TestFile!"),

...
public enum ErrorCode {
    ...
    GET_SCENE_CASE_JOB_PAGE_ERROR("4124", "Failed to get the SceneCaseJob page!"),
    GET_SCENE_CASE_JOB_ERROR("4125", "Failed to get the SceneCaseJob!"),
    GET_SCENE_CASE_BY_ID_ERROR("4126", "Failed to get the SceneCase by id!"),
    THE_API_TEST_CASE_NOT_EXITS_ERROR("4127", "The ApiTestCase no exist!"),
    THE_ENVIRONMENT_NOT_EXITS_ERROR("4128", "The Environment no exist!"),
    EXECUTE_API_TEST_CASE_ERROR("4129", "Execute the ApiTestCase error!"),
    GET_API_TEST_CASE_JOB_ERROR("4130", "Failed to get the ApiTestCaseJob!"),
    ADD_SCENE_CASE_GROUP_ERROR("4131", "Failed to add the SceneCaseGroup!"),
    EDIT_SCENE_CASE_GROUP_ERROR("4132", "Failed to edit the SceneCaseGroup!"),
    DELETE_SCENE_CASE_GROUP_ERROR("4133", "Failed to delete the SceneCaseGroup!"),
    GET_SCENE_CASE_GROUP_LIST_ERROR("4134", "Failed to get the SceneCaseGroup list!"),
    ADD_CASE_TEMPLATE_GROUP_ERROR("4135", "Failed to add the CaseTemplateGroup!"),

...
public enum ErrorCode {
    ...
    THE_PROJECT_EXIST_ERROR("4133", "The project exist! name=%s version=%s"),
    GET_SCENE_CASE_JOB_PAGE_ERROR("4134", "Failed to get the SceneCaseJob page!"),
    GET_SCENE_CASE_JOB_ERROR("4135", "Failed to get the SceneCaseJob!"),
    GET_SCENE_CASE_BY_ID_ERROR("4136", "Failed to get the SceneCase by id!"),
    THE_API_TEST_CASE_NOT_EXITS_ERROR("4137", "The ApiTestCase no exist!"),
    THE_ENVIRONMENT_NOT_EXITS_ERROR("4138", "The Environment no exist!"),
    EXECUTE_API_TEST_CASE_ERROR("4139", "Execute the ApiTestCase error!"),
    GET_API_TEST_CASE_JOB_ERROR("4140", "Failed to get the ApiTestCaseJob!"),
    ADD_SCENE_CASE_GROUP_ERROR("4141", "Failed to add the SceneCaseGroup!"),
    EDIT_SCENE_CASE_GROUP_ERROR("4142", "Failed to edit the SceneCaseGroup!"),
    DELETE_SCENE_CASE_GROUP_ERROR("4143", "Failed to delete the SceneCaseGroup!"),
    GET_SCENE_CASE_GROUP_LIST_ERROR("4144", "Failed to get the SceneCaseGroup list!"),
    ADD_CASE_TEMPLATE_GROUP_ERROR("4145", "Failed to add the CaseTemplateGroup!"),
    EDIT_CASE_TEMPLATE_GROUP_ERROR("4146", "Failed to edit the CaseTemplateGroup!"),
    DELETE_CASE_TEMPLATE_GROUP_ERROR("4147", "Failed to delete the CaseTemplateGroup!"),
    GET_CASE_TEMPLATE_GROUP_LIST_ERROR("4148", "Failed to get the CaseTemplateGroup list!"),
    GET_API_GROUP_LIST_ERROR("4149", "Failed to get the ApiGroup list!"),

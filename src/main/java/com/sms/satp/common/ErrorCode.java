...
public enum ErrorCode {
    ...
    ADD_SCENE_CASE_API_ERROR("4067", "Failed to add the SceneCaseApi!"),
    DELETE_SCENE_CASE_API_ERROR("4068", "Failed to delete the SceneCaseApi!"),
    EDIT_SCENE_CASE_API_ERROR("4069", "Failed to edit the SceneCaseApi!"),
    EDIT_SCENE_CASE_API_SORT_ORDER_ERROR("4070", "Failed to edit the SceneCaseApi sort order!"),
    GET_SCENE_CASE_API_LIST_BY_SCENE_CASE_ID_ERROR("4071", "Failed to get the SceneCaseApi list by sceneCaseId!"),
    GET_SCENE_CASE_API_BY_ID_ERROR("4072", "Failed to get the SceneCaseApi by id!"),

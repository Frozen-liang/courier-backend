...
public enum ErrorCode {
    ...
    GET_GLOBAL_FUNCTION_BY_ID_ERROR("4062","Failed to get the GlobalFunction by id!"),
    GET_GLOBAL_FUNCTION_LIST_ERROR("4063","Failed to get the GlobalFunction list!"),
    ADD_GLOBAL_FUNCTION_ERROR("4064","Failed to add the GlobalFunction!"),
    EDIT_GLOBAL_FUNCTION_ERROR("4065","Failed to edit the GlobalFunction!"),
    DELETE_GLOBAL_FUNCTION_BY_ID_ERROR("4066","Failed to delete the GlobalFunction!"),
    GET_PROJECT_FUNCTION_BY_ID_ERROR("4067","Failed to get the ProjectFunction by id!"),
    GET_PROJECT_FUNCTION_LIST_ERROR("4068","Failed to get the ProjectFunction list!"),
    ADD_PROJECT_FUNCTION_ERROR("4069","Failed to add the ProjectFunction!"),
    EDIT_PROJECT_FUNCTION_ERROR("4070","Failed to edit the ProjectFunction!"),
    DELETE_PROJECT_FUNCTION_BY_ID_ERROR("4071","Failed to delete the ProjectFunction!"),

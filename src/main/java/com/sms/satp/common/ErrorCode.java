...
public enum ErrorCode {
    ...
    ADD_CASE_TEMPLATE_ERROR("4093","Failed to add the CaseTemplate!"),
    DELETE_CASE_TEMPLATE_ERROR("4094","Failed to delete the CaseTemplate!"),
    EDIT_CASE_TEMPLATE_ERROR("4095","Failed to edit the CaseTemplate!"),
    GET_CASE_TEMPLATE_PAGE_ERROR("4096","Failed to get the CaseTemplate page!"),
    SEARCH_CASE_TEMPLATE_ERROR("4097","Failed to search the CaseTemplate!"),
    ADD_CASE_TEMPLATE_API_ERROR("4098", "Failed to add the CaseTemplateApi!"),
    DELETE_CASE_TEMPLATE_API_ERROR("4099", "Failed to delete the CaseTemplateApi!"),
    EDIT_CASE_TEMPLATE_API_ERROR("4100", "Failed to edit the CaseTemplateApi!"),
    BATCH_EDIT_CASE_TEMPLATE_API_ERROR("4101", "Failed to batch edit the CaseTemplateApi!"),
    GET_CASE_TEMPLATE_API_LIST_BY_CASE_TEMPLATE_ID_ERROR("4081", "Failed to get the CaseTemplateApi "
        + "list by caseTemplateId!"),
    GET_CASE_TEMPLATE_API_BY_ID_ERROR("4102", "Failed to get the CaseTemplateApi by id!"),
    DELETE_CASE_TEMPLATE_CONN_ERROR("4103", "Failed to delete the CaseTemplateConn!"),
    GET_CASE_TEMPLATE_CONN_LIST_ERROR("4104", "Failed to get the CaseTemplateConn list!"),
    EDIT_CASE_TEMPLATE_CONN_ERROR("4105", "Failed to edit the CaseTemplateConn!"),
    EDIT_LIST_CASE_TEMPLATE_CONN_ERROR("4106", "Failed to editList the CaseTemplateConn!"),
    GET_SCENE_CASE_CONN_ERROR("4107","Failed to get the SceneCase conn!"),
    EDIT_SCENE_CASE_CONN_ERROR("4108","Failed to get the SceneCase conn!"),

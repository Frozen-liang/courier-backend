...
public class Constants {
    ...
    public static final String PROJECT_STATISTICS_PATH = SDK_VERSION + "/project-statistics";
    ...
    public static final String GENERATOR_TEMPLATE_PATH = SDK_VERSION + "/generator-template";
    ...
    public static final String CHANNEL = SDK_VERSION + "/channel";

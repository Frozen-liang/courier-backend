...
import com.sms.courier.dto.request.ResponseResultVerificationRequest;
...
public interface ResponseResultVerificationMapper {
    ...
    ResponseResultVerification toResponseResultVerification(ResponseResultVerificationRequest request);
}
